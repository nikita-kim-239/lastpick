    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">Создать контрпик</h4>
...
<div class="modal fade" id="modalToUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel2">Редактировать контрпик</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="modalToDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel3">Удалить контрпик</h4>
...
<nav class="navbar navbar-dark bg-primary">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <button class="navbar-toggler" type="button" data-toggle="modal" id="myBtn" data-target="#modal"
...
<div class="container">
    ...
    <table border="1" cellpadding="5" class="table table-primary" id="tableOfVictims">
        ...
        <c:forEach items="${victimships}" var="victimship">
            ...
            <tr>
                ...
                <td>
                    <button onclick="victimshipUpdate(${victimship.id})" class="btn btn-warning">Редактировать</button>
                </td>
                <td>
                    <button onclick="victimshipDelete(${victimship.id})" class="btn btn-danger">Удалить</button>
                </td>
            </tr>
        </c:forEach>
